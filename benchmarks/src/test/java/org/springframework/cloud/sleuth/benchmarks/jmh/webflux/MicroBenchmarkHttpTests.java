...
public class MicroBenchmarkHttpTests {
	...
	public static class BenchmarkContext {
		...
		public enum Instrumentation {
			...
			noSleuth("spring.sleuth.enabled", "false", "/fooNoSleuth"), onEach(
					"spring.sleuth.reactor.instrumentation-type", "DECORATE_ON_EACH",
					"/foo"), onLast("spring.sleuth.reactor.instrumentation-type", "DECORATE_ON_LAST",
							"/foo"), onManual("spring.sleuth.reactor.instrumentation-type", "MANUAL", "/fooManual");
