...
import org.springframework.cloud.sleuth.autoconfig.TraceBraveBaggageConfiguration.BaggageTagSpanHandler;
...
public class TraceBraveBaggageConfigurationTests {

	static final String[] EMPTY_ARRAY = {};

	private final ApplicationContextRunner contextRunner = new ApplicationContextRunner()
			.withConfiguration(AutoConfigurations.of(TraceBraveBaggageConfiguration.class));
